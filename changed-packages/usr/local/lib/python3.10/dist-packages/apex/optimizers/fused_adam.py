...
class FusedAdam(torch.optim.Optimizer):
    ...
    def step(self, closure=None, grads=None, output_params=None, scale=None, grad_norms=None, grad_scaler=None):
        ...
        for group, group_master in zip(self.param_groups, self.param_groups_master):
            ...
            print(f"before for: Free mem: {free_mem:.2f} MB, Tot mem: {total_mem:.2f} MB, Used mem: {used_mem:.2f} MB")
            ...
            # Calculate used memory
            used_mem = total_mem - free_mem
            print(f"after for: Free mem: {free_mem:.2f} MB, Tot mem: {total_mem:.2f} MB, Used mem: {used_mem:.2f} MB")
