...
VOCAB_FILE="/workspace/shared-data/gpt2-vocab.json" #<Specify path to file>/gpt2-vocab.json
MERGE_FILE="/workspace/shared-data/gpt2-merges.txt" #<Specify path to file>/gpt2-merges.txt
